	...
	<div class="row">
			...
			<div class="panel panel-primary" style="border:1px solid #FF0A00;"> 
				...
				<div class="panel-body">
					{!! Form::open(['action' => 'SuperTravelController@store','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							{!! Form::text('title', $value=null,$attribute=['class'=>'form-control input-md','name'=>'title']); !!}
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-10">
							{!! Form::textarea('detail', $value=null,$attribute=['class'=>'form-control input-md','name'=>'detail']); !!}
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-10">
							{!! Form::text('location', $value=null,$attribute=['class'=>'form-control input-md','name'=>'location']); !!}
						</div>
					</div>
					<div class="form-group">
